...
export default function InvitationCode({
  ...
  const handleCheckCode = async () => {
    ...
    if (success) {
      toast({
        title: "Success",
        description: "Welcome to Galaxy.do!",
      });
  ...
  return (
    <Card>
      <CardHeader className="text-center md:text-left">
        <CardTitle>Galaxy.do Waitlist</CardTitle>
      </CardHeader>
      ...
      <CardFooter className="justify-center">
        <div className="text-sm text-muted-foreground text-center">
          ...
          <a
            href="https://discord.gg/DzcR3HJa"
            target="_blank"
            className="text-foreground underline underline-offset-4 block md:inline-block"
          >
